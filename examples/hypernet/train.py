...
def train(env_name, inhibition, intrinsic, num_hidden_neurons, generations, strategy="DES", seed=24109):
    ...
    with open("examples/hypernet/default_config.yaml", "r") as f:
...
def hypernet():
    ...
    #train(env_name="reacher", inhibition="none", intrinsic=True, num_hidden_neurons=64, strategy="DES",
    #      generations=7000)
    train(env_name="inverted_double_pendulum", inhibition="none", intrinsic=True, num_hidden_neurons=64, strategy="DES",
          generations=5000)
